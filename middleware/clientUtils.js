...
function getAdmin(client, userOrg) {
	var keyPath = path.join(__dirname, util.format(Constants.networkLocation + '/crypto-config/peerOrganizations/%s.logistics.com/users/Admin@%s.logistics.com/msp/keystore', userOrg, userOrg));
	var keyPEM = Buffer.from(readAllFiles(keyPath)[0]).toString();
	var certPath = path.join(__dirname, util.format(Constants.networkLocation + '/crypto-config/peerOrganizations/%s.logistics.com/users/Admin@%s.logistics.com/msp/signcerts', userOrg, userOrg));
...
function getOrdererAdmin(client) {
	var keyPath = path.join(__dirname, Constants.networkLocation + '/crypto-config/ordererOrganizations/logistics.com/users/Admin@logistics.com/msp/keystore');
	var keyPEM = Buffer.from(readAllFiles(keyPath)[0]).toString();
	var certPath = path.join(__dirname, Constants.networkLocation + '/crypto-config/ordererOrganizations/logistics.com/users/Admin@logistics.com/msp/signcerts');
	var certPEM = readAllFiles(certPath)[0];
